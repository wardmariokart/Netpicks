...
<section class="sign-in-up">
  ...
  <form class="sign-in-up__form" action="index.php?page=signUp" method="POST">
    ...
    <input class="sign-in-up__field" type="text" name="username" id="sign-up__username" placeholder="username">
    ...
    <input class="sign-in-up__field" type="password" name="password" id="sign-up__password" placeholder="password">
    ...
    <input class="sign-in-up__field" type="password" name="confirm_password" id="sign-up__password-confirm" placeholder="confirm password">
